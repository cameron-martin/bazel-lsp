...
∂
apple~
bitcode_modestring"fDeprecated: Returns the Bitcode mode to use for compilation steps. Always returns <code>'none'</code>.»
multi_arch_platform=
+
...
Ã
cppÑ
apple_bitcode_modestring"fDeprecated: Returns the Bitcode mode to use for compilation steps. Always returns <code>'none'</code>.U
...
ß
swifts
coptslist"bA list of compiler options that should be passed to <code>swiftc</code> when compiling Swift code.)A configuration fragment for Swift tools.
ö
...
framework_filesdepset"^The full set of files that should be included as inputs to link against the dynamic framework.ã
objcObjcProvider"Ù<b>Deprecated</b>. This API is deprecated and will be removed soon. Please do not depend on it. It is <i>disabled</i> with <code>---incompatible_objc_provider_remove_linking_info</code>. Use this flag to verify your code is compatible with its imminent removal. <br>A provider which contains information about the transitive dependencies linked into the dynamic framework.Â	
to_jsonstring"œ	<b>Deprecated</b>. This API is deprecated and will be removed soon. Please do not depend on it. It is <i>disabled</i> with <code>---incompatible_struct_has_no_methods</code>. Use this flag to verify your code is compatible with its imminent removal. <br>Creates a JSON string from the struct parameter. This method only works if all struct elements (recursively) are strings, ints, booleans, other structs, a list of these types or a dictionary with string keys and values of these types. Quotes and new lines in strings are escaped. Examples:<br><pre class=language-python>struct(key=123).to_json()
# {"key":123}
...
°'
CcToolchainInfos
	all_filesdepset"^Returns all toolchain files (so they can be passed to actions using this toolchain as inputs).3
ar_executablestring"The path to the ar binary._
built_in_include_directorieslist"9Returns the list of built-in directories of the compiler.!
compilerstring"C++ compiler.?
compiler_executablestring" The path to the compiler binary./
cpustring" Target CPU of the C++ toolchain.œ
dynamic_runtime_libI
?
feature_configuration$Feature configuration to be queried.(depset"ÏReturns the files from `dynamic_runtime_lib` attribute (so they can be passed to actions using this toolchain as inputs). The caller can check whether the feature_configuration enables `static_link_cpp_runtimes` feature (if not, neither `static_runtime_lib` nor `dynamic_runtime_lib` have to be used), and use `static_runtime_lib` if static linking mode is active.7
gcov_executablestring"The path to the gcov binary.3
ld_executablestring"The path to the ld binary.$
libcstring"libc version string. 
needs_pic_for_dynamic_librariesG
?
feature_configuration$Feature configuration to be queried.(bool"›Returns true if this rule's compilations should apply -fPIC, false otherwise. Determines if we should apply -fPIC for this rule's C++ compilations depending on the C++ toolchain and presence of `--force_pic` Bazel option.3
nm_executablestring"The path to the nm binary.=
objcopy_executablestring"The path to the objcopy binary.=
objdump_executablestring"The path to the objdump binary.G
preprocessor_executablestring"$The path to the preprocessor binary.—
static_runtime_libI
?
feature_configuration$Feature configuration to be queried.(depset"ÔReturns the files from `static_runtime_lib` attribute (so they can be passed to actions using this toolchain as inputs). The caller should check whether the feature_configuration enables `static_link_cpp_runtimes` feature (if not, neither `static_runtime_lib` nor `dynamic_runtime_lib` should be used), and use `dynamic_runtime_lib` if dynamic linking mode is active.9
strip_executablestring"The path to the strip binary.—
sysrootstring"ΩReturns the sysroot to be used. If the toolchain compiler does not support different sysroots, or the sysroot is the same as the default sysroot, then this method returns <code>None</code>.6
target_gnu_system_namestring"The GNU System Name.Â	
to_jsonstring"œ	<b>Deprecated</b>. This API is deprecated and will be removed soon. Please do not depend on it. It is <i>disabled</i> with <code>---incompatible_struct_has_no_methods</code>. Use this flag to verify your code is compatible with its imminent removal. <br>Creates a JSON string from the struct parameter. This method only works if all struct elements (recursively) are strings, ints, booleans, other structs, a list of these types or a dictionary with string keys and values of these types. Quotes and new lines in strings are escaped. Examples:<br><pre class=language-python>struct(key=123).to_json()
# {"key":123}
...
#   value: 1
# }
</pre><p>Deprecated: use proto.encode_text(x) instead..Information about the C++ compiler being used.
â
...
compilation_classpathdepset"+Compilation classpath for this Java target.0
javac_optionslist"Options to java compiler.˜
javac_options_listlist"⁄A list of options to java compiler. This exists temporarily for migration purposes. javac_options will return a depset in the future, and this method will be dropped once all usages have been updated to handle depsets.E
...
direct_sourcessequence"nAll direct source files from this target (no transitive files), including any headers in the 'srcs' attribute.Ö
dynamic_framework_filedepset"‚<b>Deprecated</b>. This API is deprecated and will be removed soon. Please do not depend on it. It is <i>disabled</i> with <code>---incompatible_objc_provider_remove_linking_info</code>. Use this flag to verify your code is compatible with its imminent removal. <br>The library files in .framework directories belonging to a dynamically linked framework.Á
dynamic_framework_namesdepset"√<b>Deprecated</b>. This API is deprecated and will be removed soon. Please do not depend on it. It is <i>disabled</i> with <code>---incompatible_objc_provider_remove_linking_info</code>. Use this flag to verify your code is compatible with its imminent removal. <br>Returns all names of dynamic frameworks in this provider.Ò
dynamic_framework_pathsdepset"Õ<b>Deprecated</b>. This API is deprecated and will be removed soon. Please do not depend on it. It is <i>disabled</i> with <code>---incompatible_objc_provider_remove_linking_info</code>. Use this flag to verify your code is compatible with its imminent removal. <br>Returns all framework paths to dynamic frameworks in this provider.Ã
force_load_librarydepset"≠<b>Deprecated</b>. This API is deprecated and will be removed soon. Please do not depend on it. It is <i>disabled</i> with <code>---incompatible_objc_provider_remove_linking_info</code>. Use this flag to verify your code is compatible with its imminent removal. <br>Libraries to load with -force_load.ı
imported_librarydepset"ÿ<b>Deprecated</b>. This API is deprecated and will be removed soon. Please do not depend on it. It is <i>disabled</i> with <code>---incompatible_objc_provider_remove_linking_info</code>. Use this flag to verify your code is compatible with its imminent removal. <br>Imported precompiled static libraries (.a files) to be linked into the binary.[
j2objc_librarydepset"AStatic libraries that are built from J2ObjC-translated Java code.‡
librarydepset"Ã<b>Deprecated</b>. This API is deprecated and will be removed soon. Please do not depend on it. It is <i>disabled</i> with <code>---incompatible_objc_provider_remove_linking_info</code>. Use this flag to verify your code is compatible with its imminent removal. <br>Library (.a) files compiled by dependencies of the current target.∆
link_inputsdepset"Æ<b>Deprecated</b>. This API is deprecated and will be removed soon. Please do not depend on it. It is <i>disabled</i> with <code>---incompatible_objc_provider_remove_linking_info</code>. Use this flag to verify your code is compatible with its imminent removal. <br>Link time artifacts from dependencies that do not fall into any other category such as libraries or archives. This catch-all provides a way to add arbitrary data (e.g. Swift AST files) to the linker. The rule that adds these is also responsible to add the necessary linker flags to 'linkopt'.Æ
linkoptdepset"ö<b>Deprecated</b>. This API is deprecated and will be removed soon. Please do not depend on it. It is <i>disabled</i> with <code>---incompatible_objc_provider_remove_linking_info</code>. Use this flag to verify your code is compatible with its imminent removal. <br>Linking options.\

module_mapdepset"FClang module maps, used to enforce proper use of private header files.Ò
	sdk_dylibdepset"€<b>Deprecated</b>. This API is deprecated and will be removed soon. Please do not depend on it. It is <i>disabled</i> with <code>---incompatible_objc_provider_remove_linking_info</code>. Use this flag to verify your code is compatible with its imminent removal. <br>Names of SDK .dylib libraries to link with. For instance, 'libz' or 'libarchive'.Ï
sdk_frameworkdepset"“<b>Deprecated</b>. This API is deprecated and will be removed soon. Please do not depend on it. It is <i>disabled</i> with <code>---incompatible_objc_provider_remove_linking_info</code>. Use this flag to verify your code is compatible with its imminent removal. <br>Names of SDK frameworks to link with (e.g. 'AddressBook', 'QuartzCore')..
sourcedepset"All transitive source files.˘
static_framework_filedepset"◊<b>Deprecated</b>. This API is deprecated and will be removed soon. Please do not depend on it. It is <i>disabled</i> with <code>---incompatible_objc_provider_remove_linking_info</code>. Use this flag to verify your code is compatible with its imminent removal. <br>The library files in .framework directories that should be statically linked.Â
static_framework_namesdepset"¬<b>Deprecated</b>. This API is deprecated and will be removed soon. Please do not depend on it. It is <i>disabled</i> with <code>---incompatible_objc_provider_remove_linking_info</code>. Use this flag to verify your code is compatible with its imminent removal. <br>Returns all names of static frameworks in this provider.Ô
static_framework_pathsdepset"Ã<b>Deprecated</b>. This API is deprecated and will be removed soon. Please do not depend on it. It is <i>disabled</i> with <code>---incompatible_objc_provider_remove_linking_info</code>. Use this flag to verify your code is compatible with its imminent removal. <br>Returns all framework paths to static frameworks in this provider.¿
...
umbrella_headerdepset"wClang umbrella header. Public headers are #included in umbrella headers to be compatible with J2ObjC segmented headers.ã
weak_sdk_frameworkdepset"Ï<b>Deprecated</b>. This API is deprecated and will be removed soon. Please do not depend on it. It is <i>disabled</i> with <code>---incompatible_objc_provider_remove_linking_info</code>. Use this flag to verify your code is compatible with its imminent removal. <br>Names of SDK frameworks to weakly link with. For instance, 'MediaAccessibility'. In difference to regularly linked SDK frameworks, symbols from weakly linked frameworks do not cause an error if they are not present at runtime./A provider for compilation and linking of objc.
¡
OutputGroupInfoÂ	
to_jsonstring"œ	<b>Deprecated</b>. This API is deprecated and will be removed soon. Please do not depend on it. It is <i>disabled</i> with <code>---incompatible_struct_has_no_methods</code>. Use this flag to verify your code is compatible with its imminent removal. <br>Creates a JSON string from the struct parameter. This method only works if all struct elements (recursively) are strings, ints, booleans, other structs, a list of these types or a dictionary with string keys and values of these types. Quotes and new lines in strings are escaped. Examples:<br><pre class=language-python>struct(key=123).to_json()
# {"key":123}
...
bin_dirroot"(The root corresponding to bin directory.a
build_file_pathstring"FThe path to the BUILD file for this rule, relative to the source root.¢
...
workspace_namestring"ÄThe repository part of this label. For instance, <pre class=language-python>Label("@foo//bar:baz").workspace_name == "foo"</pre>‡
workspace_rootstring"≈Returns the execution root for the workspace of this label, relative to the execroot. For instance:<br><pre class=language-python>Label("@repo//pkg/foo:abc").workspace_root == "external/repo"</pre>ÒA BUILD target identifier.<p>For every <code>Label</code> instance <code>l</code>, the string representation <code>str(l)</code> has the property that <code>Label(str(l)) == l</code>, regardless of where the <code>Label()</code> call occurs.
¬
...
‰
	integrity“Expected checksum of the file downloaded, in Subresource Integrity format. This must match the checksum of the file downloaded. It is a security risk to omit the checksum as remote files can change. At best omitting this field will make your build non-hermetic. It is optional to make development easier but should be set before shipping."''struct"ûDownloads a file to the output path for the provided url and returns a struct containing <code>success</code>, a flag which is <code>true</code> if the download completed successfully, and if successful, a hash of the file with the fields <code>sha256</code> and <code>integrity</code>.ç
...
Ü
legacy_utf8qencode file content to UTF-8, true by default. Future versions will change the default and remove this parameter."TrueNoneType"GGenerates a file in the repository directory with the provided content.æ
is_dev_dependencyz
r
...
executable=set the executable flag on the created file, true by default."True
Ü
legacy_utf8qencode file content to UTF-8, true by default. Future versions will change the default and remove this parameter."TrueNoneType"GGenerates a file in the repository directory with the provided content.I
...
archstring"}A string identifying the architecture Bazel is running on (the value of the "os.arch" Java property converted to lower case).3
environdict""The list of environment variables.í
...
<p>This API is <b>highly experimental</b> and subject to change at any time. Do not depend on the stability of this function at this time.ˇ
...
n
cc_info]A CcInfo which contains information about the transitive dependencies linked into the binary."None
r
objcdAn ObjcProvider which contains information about the transitive dependencies linked into the binary."None
Ñ
...
ä
framework_filesç<a class="anchor" href="../builtins/depset.html">depset</a> of <a class="anchor" href="../builtins/File.html">File</a>s; or <code>None</code>aThe full set of artifacts that should be included as inputs to link against the dynamic framework"NoneAppleDynamicFramework"6Creates a new AppleDynamicFramework provider instance.‚
new_executable_binary_providerÉ
Ö
binaryM<a class="anchor" href="../builtins/File.html">File</a>; or <code>None</code>&The binary artifact of the executable."None
n
cc_info]A CcInfo which contains information about the transitive dependencies linked into the binary."None
r
objcdAn ObjcProvider which contains information about the transitive dependencies linked into the binary."NoneAppleExecutableBinary":Creates a new AppleExecutableBinaryInfo provider instance.u
new_objc_provider:
*
...
android_commonandroid_common"ªDo not use this module. It is intended for migration purposes only. If you depend on it, you will be broken when it is removed.Common utilities and functionality related to Android rules.(
ApkInfo

**kwargs8(f
...
transitive_idl_jars(

transitive_idl_preprocessed(",The <code>AndroidIdlInfo</code> constructor.(Â
AndroidIdeInfo¢

java_package(

...
apks_under_test(

native_libs(",The <code>AndroidIdeInfo</code> constructor.(_
...

optimized_jar("5The <code>AndroidOptimizedJarInfo</code> constructor.(Ì
AndroidDexInfo™

...
"
shuffled_java_resource_jar"None",The <code>AndroidDexInfo</code> constructor.(Ï
...
success(

message(AnalysisTestResultInfo"4The <code>AnalysisTestResultInfo</code> constructor.(